...
function n_showLogo() {
	...
	if (nProfitCenter == "10047" || nProfitCenter == "10048" || nProfitCenter == "10049" || nProfitCenter == "10050" || nProfitCenter == "10051" || nProfitCenter == "10189") {
		logo = 'images/logo_publimag_';
	} else if (nProfitCenter == "10127" || nProfitCenter == "10128" || nProfitCenter == "10133") {
		logo = 'images/logo_publiconnect_';
	} else if (nProfitCenter == "10118" || nProfitCenter == "10142" || nProfitCenter == "10143" || nProfitCenter == "10144") {
	...
	document.write("<TR><TD><IMAGE src=" + logo + randomnumber + ".gif></IMAGE></TD></TR>");
	document.write("<TR><TD height=30></TD></TR>");
	document.write("</TABLE></TD></TR>");
	document.write("<TR><TD colspan=3><TABLE BORDER=0 cellspacing=0 cellpadding=0 width=172>");
	document.write("<TR><TD align=right><IMAGE src=images/logo_pub2000.gif></IMAGE></TD></TR>");
	document.write("</TABLE></TD></TR>");
	document.write("</TABLE></TD></TR>");
}
function n_showInfo() {
...
function n_showSpecial() {
	...
	myLine += "<TD width=21></TD><TD><A href=javascript:topDMS()><IMG src=images/ico_DMS.gif border=0></A></TD>";
	if (nIsBold) {
