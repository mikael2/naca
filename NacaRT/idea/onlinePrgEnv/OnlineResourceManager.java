...
//					IsSTCheck = tagSettings.getValAsBoolean("STCheck");
			...
			csXSLFilePath = PathsManager.adjustPath(csXSLFilePath);
			...
			{
				csXSLFilePathZoom = PathsManager.adjustPath(csXSLFilePathZoom);
			...
			{
				csXSLFilePathZoomBold = PathsManager.adjustPath(csXSLFilePathZoomBold);
			...
			{
				csXSLPSFilePath = PathsManager.adjustPath(csXSLPSFilePath);
