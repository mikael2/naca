...
- Import Projects in Eclipe in this order:
	...
	Select in yout file system the project to import (for example, D:\Dev\nacaOSS\JLib)and validate by pushing OK button.
...
Set <Your root installation path>\NacaSamples\trans\NacaTransSamples.cfg in the "Program Arguments" field.
...
To see the generated files, right click "NacaSamples" project, and select "Refresh" in the popup menu. This will compile the transcoded programs.
